...
class User
{
    ...
    function __construct()
    {
        if (!isset($this->db)) {
            ...
            $uName =$this->_dbUsername;
            $password = $this->_dbPassword;
            $conn = new mysqli($this->_dbHost, $uName, $password, $this->_dbName);
    ...
    function checkUser($userData = array())
    {
        if (!empty($userData)) {
            ...
            if ($prevResult->num_rows > 0) {
                ...
                // Insert user data
                $query = "INSERT INTO " . $this->_userTbl . 
